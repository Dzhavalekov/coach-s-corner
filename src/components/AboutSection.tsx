            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-5 text-lg text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Притежавам <Highlight>UEFA C лиценз</Highlight> и съм част от детско-юношеската школа на FC Bucephal.
                </p>
                
                <p>
                  <strong className="text-foreground">Защо работя с деца?</strong> Защото вярвам, че 
                  това е възрастта, в която се изграждат най-важните качества – <Highlight>упоритост, честност, 
                  умение да се справяш с трудности</Highlight> и да работиш с другите.
                </p>
                
                <p>
                  Футболът е само средството. Истинската ми цел е всяко дете да се чувства 
                  <Highlight>по-уверено в себе си</Highlight> – на терена и извън него.
                </p>
                
                <p>
                  Работя с деца на възраст от <Highlight>5 до 14 години</Highlight>. Независимо дали детето ви 
